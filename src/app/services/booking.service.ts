...
export const getBookingsByDateRange = async (startDate: Date, endDate: Date) => {
...
export const checkAvailability = async (productId: string, startDate: Date, endDate: Date) => {
