...
exports.deleteBookingHandler = exports.updateBookingHandler = exports.checkAvailabilityHandler = exports.getBookingsByProductHandler = exports.getBookingsByDateRangeHandler = exports.getBookingsHandler = exports.getBookingHandler = exports.createBookingHandler = void 0;
...
/** POST /bookings */
const createBookingHandler = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ensureAuth(req);
        ...
        if (!deliveryAddress)
            throw new apiError_1.default('deliveryAddress is required', 400);
        if (!deliveryTime)
...
/** GET /bookings/:id */
const getBookingHandler = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ensureAuth(req);
...
/** GET /bookings */
const getBookingsHandler = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ensureAuth(req);
...
const getBookingsByDateRangeHandler = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ensureAuth(req);
        ...
        const bookings = yield booking_model_1.default.find(base);
        res.status(200).json({ status: 'success', results: bookings.length, data: { bookings } });
    }
    catch (err) {
        next(err);
...
const getBookingsByProductHandler = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ensureAuth(req);
        const { productId } = req.params;
        if (!productId)
            throw new apiError_1.default('productId is required', 400);
        const filter = { product: new mongoose_1.default.Types.ObjectId(productId) };
...
const checkAvailabilityHandler = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        ...
        const conflict = yield booking_model_1.default.findOne({
        ...
        res.status(200).json({
            ...
            data: {
                available: !conflict,
                conflictId: (_a = conflict === null || conflict === void 0 ? void 0 : conflict._id) !== null && _a !== void 0 ? _a : null,
            },
        });
    }
    catch (err) {
...
/** PATCH /bookings/:id */
const updateBookingHandler = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ensureAuth(req);
        const booking = yield booking_model_1.default.findById(req.params.id);
        if (!booking)
        ...
        if (startDate)
            updates.startDate = parseISODate(startDate, 'startDate');
        if (endDate)
            updates.endDate = parseISODate(endDate, 'endDate');
        if (deliveryAddress)
        ...
        const updated = yield booking_model_1.default.findByIdAndUpdate(req.params.id, updates, {
            new: true,
            runValidators: true,
        });
...
/** DELETE /bookings/:id */
const deleteBookingHandler = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ensureAuth(req);
        const booking = yield booking_model_1.default.findById(req.params.id);
        if (!booking)
