...
exports.listUsers = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.updateUserRole = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield user_model_1.default.findByIdAndUpdate(req.params.id, { role }, { new: true, runValidators: true }).lean();
    if (!user)
        throw new apiError_1.default("User not found", 404);
    (0, apiResponse_1.ApiResponse)(res, 200, "Role updated", { user });
}));
// PATCH /admin/users/:id
exports.adminUpdateUser = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { name, email, photo, active } = req.body;
    const user = yield user_model_1.default.findByIdAndUpdate(req.params.id, { name, email, photo, active }, { new: true, runValidators: true }).lean();
    if (!user)
        throw new apiError_1.default("User not found", 404);
    (0, apiResponse_1.ApiResponse)(res, 200, "User updated", { user });
}));
// DELETE /admin/users/:id (soft)
exports.softDeleteUser = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_model_1.default.findByIdAndUpdate(req.params.id, { active: false }, { new: true }).lean();
    if (!user)
        throw new apiError_1.default("User not found", 404);
    (0, apiResponse_1.ApiResponse)(res, 200, "User soft-deleted", { user });
}));
// DELETE /admin/users/:id/hard
exports.hardDeleteUser = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_model_1.default.findByIdAndDelete(req.params.id).lean();
    if (!user)
        throw new apiError_1.default("User not found", 404);
