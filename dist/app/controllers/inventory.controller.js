...
exports.releaseExpiredCartItemsHandler =
  exports.checkInventoryAvailabilityHandler =
  exports.getBookedInventoryHandler =
  exports.getAvailableInventoryHandler =
  exports.deleteInventoryItemHandler =
  exports.updateInventoryItemHandler =
  exports.getInventoryItemsHandler =
  exports.getInventoryItemHandler =
  exports.createInventoryItemHandler =
    void 0;
...
const createInventoryItemHandler = async (req, res, next) => {
  try {
    const inventoryItem = await (0, inventory_service_1.createInventoryItem)(
      req.body
    );
...
const getInventoryItemHandler = async (req, res, next) => {
  try {
    const inventoryItem = await (0, inventory_service_1.getInventoryItem)(
      req.params.id
    );
    (0, apiResponse_1.ApiResponse)(
      res,
...
const getInventoryItemsHandler = async (req, res, next) => {
  try {
    const inventoryItems = await (0, inventory_service_1.getInventoryItems)(
      req.query
    );
    (0, apiResponse_1.ApiResponse)(
      res,
...
const updateInventoryItemHandler = async (req, res, next) => {
  try {
    const inventoryItem = await (0, inventory_service_1.updateInventoryItem)(
      req.params.id,
      req.body
    );
    (0, apiResponse_1.ApiResponse)(
...
const getAvailableInventoryHandler = async (req, res, next) => {
  try {
    ...
    const availableInventory = await (0,
    inventory_service_1.getAvailableInventory)(
      productId,
      new Date(startDate),
      new Date(endDate)
    );
...
const getBookedInventoryHandler = async (req, res, next) => {
  try {
    ...
    const bookedInventory = await (0, inventory_service_1.getBookedInventory)(
      productId,
      new Date(startDate),
      new Date(endDate)
    );
    (0, apiResponse_1.ApiResponse)(
      res,
      200,
      "Booked inventory retrieved successfully",
      { bookedInventory }
    );
  } catch (err) {
    next(err);
...
const checkInventoryAvailabilityHandler = async (req, res, next) => {
  try {
    ...
    const availability = await (0,
    inventory_service_1.checkInventoryAvailability)(productId, new Date(date));
    (0, apiResponse_1.ApiResponse)(
      res,
      200,
...
const releaseExpiredCartItemsHandler = async (req, res, next) => {
  try {
    ...
    (0, apiResponse_1.ApiResponse)(
      res,
      200,
      "Expired cart items released successfully",
      { count }
    );
  } catch (err) {
    next(err);
